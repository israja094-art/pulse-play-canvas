package app.lovable.zabplay.media;
...
public class MediaDeletePlugin extends Plugin {
    private static final int DELETE_REQUEST_CODE = 42424;
    ...
    @ActivityCallback
    private void deleteMediaResult(PluginCall call, com.getcapacitor.PluginResult activityResult) {
    ...
    private Uri resolveMediaUri(String rawPath) {
        ...
        return queryUri(MediaStore.Files.getContentUri("external"), normalized);
    }
